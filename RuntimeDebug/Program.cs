...
namespace RuntimeDebug
{
    class Program
    {
        ...
        private static ClrRuntime CreateRuntime(int pid, string dump, string dac)
        {
            // Create the data target.  This tells us the versions of CLR loaded in the target process.
            
            DataTarget dataTarget = DataTarget.LoadCrashDump(@"C:\Users\bs_ma\AppData\Local\Temp\dotnet.DMP");
           // DataTarget dataTarget = DataTarget.AttachToProcess(pid,3000);
